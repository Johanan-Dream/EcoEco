...
<body>
	...
	<div class="container-fluid page-header py-5 mb-5 wow fadeIn"
		...
		<div class="container text-center py-5">
			...
			<nav aria-label="breadcrumb animated slideInDown">
				<h5 class="text-white">
					<a href="/donation/donationMain">진행중인 기부</a>
					<a href="#">기부 후기</a>
				</h5>
			</nav>
		</div>
	...
	<div class="container-xxl py-5">
		<div class="container">
			...
			<div class="row gx-4" style="margin-top: 50px;">
				<!-- 페이징 처리 -->
...
let app1;
let key=0;
let value=$('select[name=sort] option:selected').val();
...
const donation={
	template:`
	    ...
	    <div class="text-center p-4">
	        <span class="text-primary me-1">달성률</span><span>모금액</span><span id="dday"></span>
...
function getList(){
	$.ajax({
		/* url:"/rest/donationList?option_idx="+value,  */
		url:"/rest/mainList", 
		type:"get",
