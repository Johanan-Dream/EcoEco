...
<%
	...
	String mem_id=dcontents.getMem().getMem_id();
%>
<!DOCTYPE html>
<html lang="en">
...
<body>
	...
	<div class="container" id="container">
		...
		<div class="col-3">
			...
			<%@ include file="../inc/mypage_sidebar2.jsp"%>
			<!-- mypage_sidebar End -->
		</div>
			...
			<section class="content" id="app1">
				<div class="container-fluid">
					...
					<!-- Main row -->
						...
						<div class="col">
							<h5 class="card-title mb-0">기부글 상세</h5>
							...
							<div class="form-group row">
								<div class="col">
									...
									<input type="text" class="form-control" name="dcontents_writer" value="<%=mem_id%>" readonly="readonly">
								</div>
							</div>	
